...
const CACHE = 'twelve-month-v14';
const ASSETS = [
  '/twelve-month/',
  '/twelve-month/index.html',
  '/twelve-month/manifest.json',
  '/icon-180.png',
  '/icon-192.png',
  '/icon-512.png',
  '/favicon.png'
...
self.addEventListener('fetch', e => {
  ...
  e.respondWith(
    fetch(e.request).then(res => {
      ...
      return res;
    }).catch(() => caches.match(e.request).then(r => r || caches.match('/twelve-month/index.html')))
  );
});
