...
const CACHE = 'renewal-year-v12';
const ASSETS = [
  '/renewal-year/',
  '/renewal-year/index.html',
  '/renewal-year/manifest.json',
  '/icon-180.png',
  '/icon-192.png',
  '/icon-512.png',
  '/favicon.png'
...
self.addEventListener('fetch', e => {
  ...
  e.respondWith(
    fetch(e.request).then(res => {
      ...
      return res;
    }).catch(() => caches.match(e.request).then(r => r || caches.match('/renewal-year/index.html')))
  );
});
