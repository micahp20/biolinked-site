...
const CACHE = 'mpauldino-preview-v1';
const ASSETS = [
  '/mpauldino-preview/',
  '/mpauldino-preview/index.html',
  '/mpauldino-preview/manifest.json',
  '/mpauldino/photo.jpg',
  '/icon-180.png',
  '/icon-192.png',
  '/icon-512.png',
...
self.addEventListener('fetch', e => {
  ...
  e.respondWith(
    fetch(e.request).then(res => {
      ...
      return res;
    }).catch(() => caches.match(e.request).then(r => r || caches.match('/mpauldino-preview/index.html')))
  );
});
