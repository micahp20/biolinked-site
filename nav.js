...
@media(max-width:768px){.bl-nav-links{display:none}.bl-nav-mobile-btn{display:block}.bl-nav-inner{padding:0 16px}}
  ...
  <div style="max-width:1100px;margin:0 auto;padding:10px 32px;display:flex;align-items:center;justify-content:space-between;gap:20px;flex-wrap:wrap;">
    ...
    <a href="/biomarker-landing.html" style="flex-shrink:0;background:#7A6530;color:#fff;font-family:'Montserrat',sans-serif;font-size:9px;font-weight:700;letter-spacing:0.16em;text-transform:uppercase;padding:8px 20px;text-decoration:none;white-space:nowrap;">Run Your Analysis →</a>
  </div>
</div>`;
  ...
  <div style="max-width:1100px;margin:24px auto 0;padding-top:20px;border-top:1px solid rgba(0,0,0,0.08);display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px;">
    ...
    <a href="/biomarker-landing.html" style="font-size:9px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:#fff;background:#7A6530;padding:7px 18px;text-decoration:none;">Get Your Protocol →</a>
  </div>
</div>`;
