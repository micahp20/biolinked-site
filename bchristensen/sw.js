...
const CACHE = 'bchristensen-v11';
const ASSETS = [
  '/bchristensen/',
  '/bchristensen/index.html',
  '/bchristensen/manifest.json',
  '/icon-180.png',
  '/icon-192.png',
  '/icon-512.png',
  '/favicon.png'
...
self.addEventListener('fetch', e => {
  ...
  e.respondWith(
    fetch(e.request).then(res => {
      ...
      return res;
    }).catch(() => caches.match(e.request).then(r => r || caches.match('/bchristensen/index.html')))
  );
});
