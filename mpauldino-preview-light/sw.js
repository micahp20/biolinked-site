...
const CACHE = 'mpauldino-preview-light-v1';
const ASSETS = [
  '/mpauldino-preview-light/',
  '/mpauldino-preview-light/index.html',
  '/mpauldino-preview-light/manifest.json',
  '/mpauldino/photo.jpg',
  '/icon-180.png',
  '/icon-192.png',
  '/icon-512.png',
...
self.addEventListener('fetch', e => {
  ...
  e.respondWith(
    fetch(e.request).then(res => {
      ...
      return res;
    }).catch(() => caches.match(e.request).then(r => r || caches.match('/mpauldino-preview-light/index.html')))
  );
});
